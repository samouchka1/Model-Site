...
const panelText1 = document.getElementById("panel-text1"); /*test*/
...
closeClick.addEventListener("click", closeNav);
  ...
  function closeNav() {
    ...
    panelText1.style.display = "none"; /*test*/
  }
...
const panelText2 = document.getElementById("panel-text2"); /*test*/
...
closeClick2.addEventListener("click", closeNav2);
  ...
  function closeNav2() {
    ...
    panelText2.style.display = "none"; /*test*/
  }
...
//SIDE PANEL 3
  ...
  const panelText3 = document.getElementById("panel-text3"); /*test*/
  ...
  closeClick3.addEventListener("click", closeNav3);
    ...
    function closeNav3() {
      ...
      panelText3.style.display = "none"; /*test*/
    }
